...
import zipfile
import shutil
from Crowd_Detection.utils.main_utils import read_yaml_file
from Crowd_Detection.logger import logging
from Crowd_Detection.exception import AppException
from Crowd_Detection.entity.config_entity import ModelTrainerConfig
from Crowd_Detection.entity.artifacts_entity import ModelTrainerArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        ...
        try:
            ...
            shutil.rmtree("README.dataset.txt", ignore_errors=True)
            shutil.rmtree("README.roboflow.txt", ignore_errors=True)
            os.remove("data.yaml")
